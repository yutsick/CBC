...
<div class="affwp-creative<?php echo esc_attr( $affwp_creative_atts['id_class'] ); ?>">
	...
	<?php if ( $affwp_creative_atts['preview'] != 'no' ) : ?>
		...
		<p>
			<a href="<?php echo esc_attr( $affwp_creative_atts['image_attributes'][0] ); ?>" title="<?php echo esc_attr( $affwp_creative_atts['text'] ); ?>" download>
		...
		?>
			<p>
				<a href="<?php echo esc_attr( $affwp_creative_atts['image_link'] ); ?>" title="<?php echo esc_attr( $affwp_creative_atts['text'] ); ?>" download>
