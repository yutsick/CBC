		...
		wp_send_json(
			array(
				'fragments' => apply_filters(
					...
					array(
						'form.woocommerce-checkout' => '<div class="woocommerce-error">' . __( 'Sorry, your session has expired.', 'woocommerce' ) . ' <a href="/candidates" class="wc-backward">' . __( 'Return to Candidates', 'woocommerce' ) . '</a></div>',
					)
				),
			)
		);
		...
		wp_send_json(
			array(
				...
				'fragments' => apply_filters(
					'woocommerce_update_order_review_fragments',
					array(
						'.woocommerce-checkout-review-order-table' => $woocommerce_oupdarder_review,
