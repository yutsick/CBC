	...
	<?php else : ?>
		<p class="no_subscriptions woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info">
			<?php if ( 1 < $current_page ) :
				...
				?>
				<a class="woocommerce-Button button" href="<?php echo esc_url( home_url( '/all-candidates/' ) ); ?>">
					<?php esc_html_e( 'Browse Candidates', 'woocommerce-subscriptions' ); ?>
				</a>
			
				<a class="woocommerce-Button button" href="<?php echo esc_url( home_url( '/general-donation/' ) ); ?>">
					<?php esc_html_e( 'General Donation', 'woocommerce-subscriptions' ); ?>
				</a>
			<?php
		endif; ?>
		</p>
